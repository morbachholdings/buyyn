                  ...
                  >
                    ...
                    >
                      ...
                      <div class="d-flex justify-content-end">
                        ...
                        <a
                          href="../../demo22/dist/pages/search/horizontal.html"
                ...
                <div class="app-navbar-item" id="kt_header_user_menu_toggle">
                  ...
                  >
                    ...
                    <div class="menu-item px-5">
                      <a
                        href="../../demo22/dist/account/overview.html"
                    ...
                    <div class="menu-item px-5">
                      <a
                        href="../../demo22/dist/authentication/layouts/corporate/sign-in.html"
                        class="menu-link px-5"
                        >Sign Out</a
                      >
                    </div>
  ...
  >
    <div class="card shadow-none border-0 rounded-0">
                ...
                <div class="overflow-auto pb-5">
                  ...
                  >
                    ...
                    <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                      <!--begin::Icon-->
                      <img
                        alt="../../demo22/dist/apps/projects/project.html"
                        class="w-30px me-3"
      ...
      <div class="card-footer py-5 text-center" id="kt_activities_footer">
        <a
          href="../../demo22/dist/pages/user-profile/activity.html"
                                            ...
                                            <div class="tab-pane fade show active" id="kt_list_widget_10_tab_1">
                                              <div class="m-0">
                                                  <div class="card-body pt-0">
                                                      <div class="col-xl-12">
                                                        <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#kt_modal_1"><i class="fa-solid fa-user-plus fs-4 me-2"></i>
                                                          Add new Suppliers
                                                      </button>
                                                      
                                                      <div class="modal fade addNewModal" tabindex="-1" id="kt_modal_1">
                                                          <div class="modal-dialog">
                                                              <div class="modal-content">
                                                                  <div class="modal-header">
                                                                      <h3 class="modal-title">Add New Suppliers</h3>
                                                                  ...
                                                                  <div class="modal-body">
                                                                    ...
                                                                    <div class="py-5">
                                                                      <div class="d-flex flex-column flex-md-row rounded border p-4">
                                                                        <ul class="nav nav-tabs nav-pills flex-row border-0 flex-md-column me-5 mb-3 mb-md-0 fs-6 min-w-lg-150px">
                                                                          ...
                                                                          <li class="nav-item w-100 me-0 mb-md-2">
                                                                            <a class="nav-link w-100 btn btn-flex btn-active-light-info" data-bs-toggle="tab" href="#kt_vtab_pane_5">
                                                                              ...
                                                                              <span class="d-flex flex-column align-items-start">
                                                                                <span class="fs-4 fw-bold">Accounts</span>
                                                                          ...
                                                                          <li class="nav-item w-100">
                                                                            <a class="nav-link w-100 btn btn-flex btn-active-light-danger" data-bs-toggle="tab" href="#kt_vtab_pane_6">
                                                                              ...
                                                                              <span class="d-flex flex-column align-items-start">
                                                                                <span class="fs-4 fw-bold">Rebates</span>
                                                                        ...
                                                                        <div class="tab-content w-100" id="myTabContent">
                                                                          <div class="tab-pane fade show active w-100" id="kt_vtab_pane_4" role="tabpanel">
                                                                            <div class="d-flex justify-content-center flex-column w-100">
                                                                              <div class="mx-auto mb-5">
                                                                             <!--begin::Image input-->
 <div class="image-input image-input-circle shadow d-flex justify-content-center align-items-center img-fluid w-80px h-80px" data-kt-image-input="true" style="background-image: url(/assets/media/svg/avatars/blank.svg)">
  <!--begin::Image preview wrapper-->
  <div class="image-input-wrapper w-80px h-80px img-fluid d-flex justify-content-center align-items-center" style="background-image: url(/assets/media/avatars/300-20.jpg)"></div>
...
<div class="fv-row mb-2">
  ...
  <!--begin::Input-->
  <input type="password" name="text_input" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="" value="" />
  <!--end::Input-->
</div>
<!--end::Input group-->
...
<form id="kt_docs_formvalidation_text" class="form" action="#" autocomplete="off">
<!--begin::Input group-->
<div class="fv-row mb-2 mt-5 px-4">
  <!--begin::Label-->
  <label class="fw-semibold fs-6 mb-2">Contact Person's Name</label>
  <!--end::Label-->
...
<div class="fv-row mb-2 px-4">
  ...
  <!--begin::Input-->
  <input type="email" name="text_input" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="" value="" />
  <!--end::Input-->
</div>
<!--end::Input group-->
                                                                          ...
                                                                          <div class="tab-pane fade w-100" id="kt_vtab_pane_5" role="tabpanel">
                                                                            <div class="d-flex justify-content-center flex-column w-100">
                                                                                  ...
                                                                                  <form id="kt_docs_formvalidation_text" class="form" action="#" autocomplete="off">
                                                                                    ...
                                                                                    <div class="fv-row mb-2 mt-5">
                                                                                        <!--begin::Label-->
                                                                                        <label class="fw-semibold fs-6 mb-2">Accounts Person Name</label>
                                                                                        <!--end::Label-->
                                                                                    ...
                                                                                    <!--end::Input group-->
                                                                                     ...
                                                                                     <div class="fv-row mb-2">
                                                                                      <!--begin::Label-->
                                                                                      <label class="fw-semibold fs-6 mb-2">Accounts Person Phone</label>
                                                                                      <!--end::Label-->
                                                                                  ...
                                                                                  <div class="fv-row mb-2">
                                                                                    <!--begin::Label-->
                                                                                    <label class="fw-semibold fs-6 mb-2">Account's Person Email Address</label>
                                                                                    <!--end::Label-->
                                                                          ...
                                                                          <div class="tab-pane fade" id="kt_vtab_pane_6" role="tabpanel">
                                                                            <div class="d-flex justify-content-center flex-column w-100">
                                                                              ...
                                                                              <form id="kt_docs_formvalidation_text" class="form" action="#" autocomplete="off">
                                                                                ...
                                                                                <div class="fv-row mb-2 mt-5">
                                                                                    <!--begin::Label-->
                                                                                    <label class="fw-semibold fs-6 mb-2">SHQ Rebate %</label>
                                                                                    <!--end::Label-->
                                                                                ...
                                                                                <!--end::Input group-->
                                                                                 ...
                                                                                 <div class="fv-row mb-2">
                                                                                  <!--begin::Label-->
                                                                                  <label class="fw-semibold fs-6 mb-2">Member's Rebate %</label>
                                                                                  <!--end::Label-->
                                                                              ...
                                                                              <div class="fv-row mb-2">
                                                                                <!--begin::Label-->
                                                                                <label class="fw-semibold fs-6 mb-2">Rebate Calculated</label>
                                                                                <!--end::Label-->
                                                        ...
                                                        <table id="kt_datatable_dom_positioning2" class="table table-striped table-row-bordered gy-5 gs-7 border rounded">
                                                          <thead>
                                                              <tr class="fw-bold fs-6 text-gray-800 px-7">
                                                                <th><label class="form-check form-check-inline">
                                                                  <input
                                                                    class="form-check-input"
                                                                    type="checkbox"
                                                                    name="toc"
                  ...
                  <!--end::Indicator label-->
                                            ...
                                            <div class="tab-pane fade" id="kt_list_widget_10_tab_2">
                                                <div class="m-0">
                                                    <div class="card-body pt-0">
                                                        <div class="col-xl-12">
                                                          <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#kt_modal_2"><i class="fa-solid fa-user-plus fs-4 me-2"></i>
                                                            Add new Members
                                                        </button>

                                                        <div class="modal fade addNewModal" tabindex="-1" id="kt_modal_2">
                                                          <div class="modal-dialog">
                                                              <div class="modal-content">
                                                                  <div class="modal-header">
                                                                      <h3 class="modal-title">Add New Members</h3>
                                                                  ...
                                                                  <div class="modal-body">
                                                                    ...
                                                                    <div class="py-5">
                                                                      <div class="d-flex flex-column flex-md-row rounded border p-4">
                                                                        <ul class="nav nav-tabs nav-pills flex-row border-0 flex-md-column me-5 mb-3 mb-md-0 fs-6 min-w-lg-150px">
                                                                          <li class="nav-item w-100 me-0 mb-md-2">
                                                                            <a class="nav-link w-100 active btn btn-flex btn-active-light-success" data-bs-toggle="tab" href="#kt_vtab_pane_7">
                                                                          ...
                                                                          <li class="nav-item w-100 me-0 mb-md-2">
                                                                            <a class="nav-link w-100 btn btn-flex btn-active-light-info" data-bs-toggle="tab" href="#kt_vtab_pane_8">
                                                                          ...
                                                                          <li class="nav-item w-100">
                                                                            <a class="nav-link w-100 btn btn-flex btn-active-light-danger" data-bs-toggle="tab" href="#kt_vtab_pane_9">
                                                                        ...
                                                                        <div class="tab-content w-100" id="myTabContent">
                                                                          <div class="tab-pane fade show active w-100" id="kt_vtab_pane_7" role="tabpanel">
                                                                            <div class="d-flex justify-content-center flex-column w-100">
                                                                              <div class="mx-auto mb-5">
                                                                             <!--begin::Image input-->
 <div class="image-input image-input-circle shadow d-flex justify-content-center align-items-center img-fluid w-80px h-80px" data-kt-image-input="true" style="background-image: url(/assets/media/svg/avatars/blank.svg)">
...
<!--end::Input group-->
                                                                          ...
                                                                          <div class="tab-pane fade w-100" id="kt_vtab_pane_8" role="tabpanel">
                                                                            <div class="d-flex justify-content-center flex-column w-100">
                                                          ...
                                                          <table id="kt_datatable_dom_positioning3" class="table table-striped table-row-bordered gy-5 gs-7 border rounded">
                                                            <thead>
                                                                <tr class="fw-bold fs-6 text-gray-800 px-7">
                                                                    <th><label class="form-check form-check-inline">
                                                                      <input
                    ...
                    <!--end::Indicator label-->
                                            ...
                                            <div class="tab-pane fade" id="kt_list_widget_10_tab_3">
                                              <div class="m-0">
                                                  <div class="card-body pt-0">
                                                      <div class="col-xl-12">
                                                        <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#kt_modal_3"><i class="fa-solid fa-user-plus fs-4 me-2"></i>
                                                          Add new Admins
                                                      </button>

                                                      <div class="modal fade addNewModal" tabindex="-1" id="kt_modal_3">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h3 class="modal-title">Add New Admins</h3>
                                                                ...
                                                                <div class="modal-body">
                                                                  ...
                                                                  <form id="kt_docs_formvalidation_text" class="form" action="#" autocomplete="off">
                                                                    ...
                                                                    <div class="fv-row mb-2 mt-5">
                                                                        <!--begin::Label-->
                                                                        <label class="fw-semibold fs-6 mb-2">User Name</label>
                                                                        <!--end::Label-->
                                                        ...
                                                        <table id="kt_datatable_dom_positioning4" class="table table-striped table-row-bordered gy-5 gs-7 border rounded">
                                                          <thead>
                                                              <tr class="fw-bold fs-6 text-gray-800 px-7">
                                                                <th><label class="form-check form-check-inline">
                                                                  <input
