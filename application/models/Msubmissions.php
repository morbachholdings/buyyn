...
class Msubmissions extends CI_Model
{
    ...
    WHERE
        ...
        AND STATUS = 1 AND ISNULL(deleted_date)";
    ...
    WHERE
        ...
        AND is_child =0 AND ISNULL(submissions.deleted_date)";
    ...
    WHERE
        is_child = 1
        AND reference_number = '" . $reference . "' AND ISNULL(submissions.deleted_date)";
        return $this->db->query($sql);
    }
