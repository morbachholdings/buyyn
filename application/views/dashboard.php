                ...
                <div class="d-flex flex-column flex-column-fluid">
                    ...
                    <div id="kt_app_content" class="app-content flex-column-fluid">
                        ...
                        <div class="row g-5 g-xl-10 mb-xl-10">
                            <!--begin::Col-->
                            <div class="col-md-12 col-lg-4 col-xl-4 col-xxl-4 mb-md-5 mb-xl-10">
                                <!--begin::Card widget 5-->
                                ...
                                <div class="card card-flush h-100 mb-5 mb-xl-10">
                                    ...
                                    <div class="card-header pt-5">
                                        ...
                                        <div class="card-title d-flex flex-column">
                                            ...
                                            <!--end::Info-->
                                            <!--begin::Subtitle-->
                                            <span class="text-gray-400 pt-1 fw-semibold fs-6">Rebate Earnings</span>
                                            <!--end::Subtitle-->
                                        </div>
                                        <!--end::Title-->
                                    </div>
                                ...
                                <div class="card card-flush h-xl-100">
                                    ...
                                    <div class="card-header pt-7">
                                        ...
                                        <h3 class="card-title align-items-start flex-column">
                                            <span class="card-label fw-bold text-dark">Process Log</span>
                                        ...
                                        <div class="card-toolbar">
                                            ...
                                            <div class="d-flex flex-stack flex-wrap gap-4">
                                                ...
                                                <!--end::Status-->
                                                <!--begin::Search-->
                                                <!-- <a href="../../demo2/dist/apps/ecommerce/catalog/products.html" class="btn btn-light btn-sm">View Stock</a> -->
                                                <!--end::Search-->
                                            </div>
                                            <!--begin::Filters-->
                                        </div>
                                        ...
                                        <table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_5_table">
                                            ...
                                            <thead>
                                                ...
                                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                    ...
                                                    <th class=" pe-3 min-w-100px">Process Title</th>
                                                    <th class=" pe-3 min-w-100px">Time</th>
                                                    <th class="pe-3 min-w-50px">Status</th>
                                                    <th class=" pe-0 min-w-25px">User</th>
                                                </tr>
                                                <!--end::Table row-->
                                            </thead>
                                            <!--end::Table head-->
                                            ...
                                            <tbody class="fw-bold text-gray-600">
                                                <?php foreach ($all_log->result() as $row) { ?>
                                                    <tr>
                                                        <td>
                                                            <?php if ($row->process_type_id == 200) { ?>
                                                                <span class="badge py-3 px-4 fs-7 badge-light-success">200 OK</span>
                                                            <?php } else if ($row->process_type_id == 552) { ?>
                                                                <span class="badge py-3 px-4 fs-7 badge-light-warning">552 ERROR</span>
                                                            <?php } else { ?>
                                                        ...
                                                        $diff = date_diff($now, date_create($row->process_time));
                                                        $time = "";
