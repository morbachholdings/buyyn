                        ...
                        <div class="d-flex flex-stack flex-grow-1 flex-lg-grow-0">
                            ...
                            <div class="d-flex align-items-center me-7">
                                ...
                                <a href="#" class="d-flex align-items-center">
                                    <img alt="Logo" src="<?php echo base_url() ?><?php echo base_url() ?>assets//media/logos/logo.png" class="h-25px h-lg-30px" />
                                </a>
                                <!--end::Logo-->
                            </div>
                            <!--end::Logo wrapper-->
                                            ...
                                            <div class="tab-pane fade" id="kt_topbar_notifications_2" role="tabpanel">
                                                ...
                                                <div class="d-flex flex-column px-9">
                                                    ...
                                                    <div class="text-center px-4">
                                                        <img class="mw-100 mh-200px" alt="image" src="<?php echo base_url() ?>assets/media/illustrations/sigma-1/1.png" />
                                                    </div>
                                                    <!--end::Illustration-->
                                                </div>
                                                <!--end::Wrapper-->
                    ...
                    <div class="app-container container-xxl app-container-fit-mobile d-flex align-items-stretch">
                        ...
                        <div class="header-menu d-flex align-items-stretch w-100">
                            ...
                            <div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-state-primary menu-title-gray-700 menu-arrow-gray-400 menu-bullet-gray-400 fw-semibold my-5 my-lg-0 align-items-stretch" id="#kt_header_menu" data-kt-menu="true">
                                ...
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link py-3" href="submission.php">
                                        <span class="menu-title">
                                ...
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link py-3" href="admins.php">
                                        <span class="menu-title">
                                ...
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link py-3" href="rebates.php">
                                        <span class="menu-title">
                                ...
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link py-3" href="reports.php">
                                        <span class="menu-title">
