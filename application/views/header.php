...
<body id="kt_body" data-kt-app-header-stacked="true" class="app-default">
    ...
    <div class="d-flex flex-column flex-root app-root" id="kt_app_root">
        ...
        <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane fade show active" id="kt_topbar_notifications_2" role="tabpanel">
                                                ...
                                                <div class="d-flex align-items-end justify-content-end">
                                                    <a href="javascript:;">
                                                        <p class="align-end mt-3 mx-4" id="markAllRead">Mark all as read</p>
                                                    </a>
                                                </div>
            ...
            <!-- <script src="<?php //echo base_url() ?>assets/js/custom/Table/PendingSubmission/dateFilter.js"></script> -->
                        ...
                        success: function(data) {
                            ...
                            if (data.status == 1) {
                                ...
                                $.each(values, function(index) {
                                    ...
                                    html += '<a href="<?php echo base_url() ?>submissions/view_submission?id=' + values[index].description + '" class="fs-6 text-gray-800 text-hover-primary fw-bold">' + values[index].title + '</a>';
