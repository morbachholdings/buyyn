...
<body>
    <div class="d-flex flex-column flex-root">
        ...
        <div class="page d-flex flex-row flex-column-fluid">
                                                    ...
                                                    <div class="card-body pt-0">
                                                        <div class="col-xl-12">
                                                            ...
                                                            <div class="card card-flush">
                                                                ...
                                                                <div class="card-header align-items-center py-1 gap-2 gap-md-5">
                                                                    ...
                                                                    <div class="card-title">
                                                                        ...
                                                                        <div class="d-flex align-items-center position-relative my-1">
                                                                            ...
                                                                            <!--end::Svg Icon-->
                                                                            <input type="text" data-kt-ecommerce-product-filter="search" id="shqEarningSearch" onkeyup="searchFunctionShq()" class="form-control form-control-solid w-250px ps-14" placeholder="Search Supplier" />
                                                                        </div>
                                                                        <!--end::Search-->
                                                                    </div>
                                                                    <!--end::Card title-->
                                                                    ...
                                                                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_products_table_1">
                                                                        ...
                                                                        <thead>
                                                                            ...
                                                                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                                                ...
                                                                                <th class="text-start min-w-100px">SHQ Rebates %</th>
                                                                                <th class="text-start min-w-100px">Amount</th>
                                                                                <th class="text-start min-w-100px">Rebates Period</th>
                                                                        ...
                                                                        <tbody class="fw-semibold text-gray-600">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <!--begin::Status=-->
                                                                                <td class="text-start pe-0" data-order="Monthly">
                                                                                    <!--begin::Badges-->
                                                                                    Monthly
                                                                                    <!--end::Badges-->
                                                                                </td>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <!--begin::Status=-->
                                                                                <td class="text-start pe-0" data-order="Quaterly">
                                                                                    <!--begin::Badges-->
                                                                                    Quaterly
                                                                                    <!--end::Badges-->
                                                                                </td>
                                                                ...
                                                                <!--begin::Status=-->
                                                                <td class="text-start pe-0" data-order="Annually">
                                                                    <!--begin::Badges-->
                                                                    Annually
                                                                    <!--end::Badges-->
                                                                </td>
                                                            ...
                                                            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                                                ...
                                                                <div class="card-title">
                                                                    ...
                                                                    <div class="d-flex align-items-center position-relative my-1">
                                                                        ...
                                                                        <!--end::Svg Icon-->
                                                                        <input type="text" data-kt-ecommerce-earning-filter="search" id="memberEarningSearch" onkeyup="searchFunctionMember()" class="form-control form-control-solid w-250px ps-14" placeholder="Search Supplier" />
                                                                    </div>
                                                                    <!--end::Search-->
                                                                </div>
                                                                <!--end::Card title-->
                                                                ...
                                                                <div class="card-toolbar flex-row-fluid justify-content-between gap-5">
                                                                    ...
                                                                    <div id="kt_datatable_example_export_member_menu" class="menu menu-sub menu-sub-dropdown menu-column menu-rounded-4 menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4" data-kt-menu="true">
                                                                        <!--begin::Menu item-->
                                                                        <div class="menu-item px-3">
                                                                            <a href="#" class="menu-link px-3" data-kt-member-export="csv">
                                                                                Export as CSV
                                                                            </a>
                                                                        </div>
                                                                        <!--end::Menu item-->
                                                                    ...
                                                                    <!--end::Export dropdown-->
                                                                    <!--begin::Hide default export buttons-->
                                                                    <div id="kt_datatable_example_member_buttons" class="d-none"></div>
                                                                    <!--end::Hide default export buttons-->
                                                            ...
                                                            <div class="card-body pt-0">
                                                                ...
                                                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_earning_table_1">
                                                                    ...
                                                                    <thead>
                                                                        ...
                                                                        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                                            <th class="min-w-100px">Supplier Name</th>
                                                                            <th class="text-start min-w-100px">Member Rebates %</th>
                                                                            <th class="text-start min-w-100px">Amount</th>
                                                                            <th class="text-start min-w-100px">Rebates Period</th>
                                                                            <th class="text-start min-w-50px">Actions</th>
                                                                        </tr>
                                                                    ...
                                                                    <tbody class="fw-semibold text-gray-600">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <p class="text-gray-800 text-hover-primary fs-5 fw-bold" data-kt-ecommerce-earning-filter="product_name">Andrew</p>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <p class="text-gray-800 text-hover-primary fs-5 fw-bold" data-kt-ecommerce-earning-filter="product_name">Peter</p>
          ...
          <script src="<?php echo base_url() ?>assets/js/custom/Table/rebates/SHQearnings.js"></script>
          <script src="<?php echo base_url() ?>assets/js/custom/Table/rebates/memberearnings.js"></script>
          <script src="<?php echo base_url() ?>assets/js/custom/Table/rebates/exportSHQ.js"></script>
          <script src="<?php echo base_url() ?>assets/js/custom/Table/rebates/exportMember.js"></script>
