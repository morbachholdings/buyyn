...
<body style="background: rgb(244, 247, 249);">
                                                                    ...
                                                                    <div class="m-0">
                                                                        <div class="card-body pt-5">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-md-3 mb-1 mt-2">
                                                                                    <select id="financialMonth" name="language" aria-label="Select Month" data-control="select2" data-placeholder="Select a language..." class="form-select form-select-solid form-select-lg">
                                                                                ...
                                                                                <div class="col-md-3 mb-1 mt-2">
                                                                                    <select id="supplier" name="language" aria-label="Select Year" data-control="select2" data-placeholder="Select a language..." class="form-select form-select-solid form-select-lg">
                                                                                ...
                                                                                <div class="col-md-3 d-flex mt-2">
                                                                                    <button class="btn btn-primary my-0 w-150px h-45px" id="btnAddParent">Apply</button>
                                                                                </div>
                                                                                    ...
                                                                                    <div class="card-body py-0">
                                                                                        ...
                                                                                        <div class="row justify-content-between my-3 align-items-center" style="margin-top:40px;" id="grandSection" hidden>
                                                                                            <div class="rounded-2 bg-light-primary p-3 col-6 d-flex justify-content-between w-100 w-md-50 my-1">
                                                                                                <p class="m-0 fw-bolder fs-3">
                                                                                                    <b>Grand
                                                                                                        Total</b>
                                                                                                </p>
                                                                                                <p class="m-0 fw-bold fs-3" id="total_sum">
                                                                                                    <b></b>
                                                                                                </p>
                                                                                            </div>
                                                                                            <div class="col-6 d-flex align-items-end justify-content-end my-1">
                                                                                                <div class="text-end">
                                                                                                    <button type="submit" id="btnSubmit" class="btn btn-sm btn-success me-2 rounded-3 p-2 w-80px" onclick="disable(this)">
                                                                                                        <!--begin::Indicator label-->
                                                                                                        <span class="indicator-label">Submit</span>
                                                                                                        <!--end::Indicator label-->
                                                                                                    ...
                                                                                                    <!-- <a class="btn btn-sm btn-success me-2 rounded-3 p-2 w-80px" href="javascript:;" id="btnSubmit">Submit</a> -->
                                                                                                </div>
    ...
    <script>
        ...
        $('.btnInvoice').click(function() {
            ...
            Swal.fire({
                text: "Are you sure you want to mark " + reference + " reference as Invoiced ?",
                icon: "warning",
                showCancelButton: !0,
                buttonsStyling: !1,
                ...
                if (e.value) {
                    ...
                    $.ajax({
                        url: "<?php echo base_url(); ?>Submissions/mark_invoiced",
                        method: "POST",
                        data: {
                            reference: reference
                        ...
                        success: function(data) {
                            swal.fire({
                                text: reference + " mark as invoiced ! ",
                                icon: "success",
                                buttonsStyling: false,
                                confirmButtonText: "Ok, got it!",
                                customClass: {
        ...
        $('.btnDelete').click(function() {
            var reference = $(this).attr('refNum');
            Swal.fire({
                text: "Are you sure you want to delete " + reference + " reference ?",
                icon: "warning",
                showCancelButton: !0,
                buttonsStyling: !1,
                confirmButtonText: "Yes, delete!",
                ...
                if (e.value) {
                    ...
                    $.ajax({
                        url: "<?php echo base_url(); ?>Submissions/mark_deleted",
                        method: "POST",
                        data: {
                            reference: reference
                    ...
                    success: function(data) {
                        ...
                        if (ret_data.status == 0) {
                            ...
                            Swal.fire({
                                ...
                                icon: "error",
                                html: '<a href="<?php echo base_url() ?>submissions/view_submission?id=' +
