                                                                        ...
                                                                        <div class="card-body pt-5">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-md-3 d-flex mt-2">
                                                                                    <button
                                                                                        class="btn btn-primary my-0 w-150px h-45px"
                                                                                        id="btnAddParent">Apply</button>
                                                                                </div>
                                                                                ...
                                                                                <div class="card card-flush h-xl-100">
                                                                                    ...
                                                                                    <div class="card-body py-0">
                                                                                            ...
                                                                                            <table
                                                                                                ...
                                                                                                <tbody class="scroll-y">
                                                                                                    ...
                                                                                                    <tr
                                                                                                        ...
                                                                                                        <td
                                                                                                            class="col-3 text-start px-4 fs-6 member_name">
                                                                                                            <?php echo $row->Company_name ?>
                                                                                                        </td>
                                                                                                        <td
                                                                                                            ...
                                                                                                            <input
                                                                                                                ...
                                                                                                                name="currency-field"
                                                                                                                id="currency-field"
                                                                                                                class="amount_val border-light bg-light rounded"
                                                                                                                pattern="^\$\d{1,3}(,\d{3})*(\.\d+)?$"
                                                                                                                value=""
                                                                                                                data-type="currency"
                                                                                                        ...
                                                                                                        <td
                                                                                                            ...
                                                                                                            <img class="mx-2"
                                                                                                                src="<?php echo base_url() ?>assets/media/icons/duotune/abstract/abs011.svg"
                                                                                                                alt=""
                                                                                                                style="height:16px;width:16px;"><img
                                                                                                                src="<?php echo base_url() ?>assets/media/icons/duotune/art/art005.svg"
                                                                                                                alt=""
                                                                                                        ...
                                                                                                        <td
                                                                                                            ...
                                                                                                            <span
                                                                                                                class="text-start badge badge-light-primary py-3">$
                                                                                        ...
                                                                                        <div class="row justify-content-between my-3 align-items-center"
                                                                                            ...
                                                                                            id="grandSection" hidden>
                                                                                            <div
                                                                                                class="rounded-2 bg-light-primary p-3 col-6 d-flex justify-content-between w-100 w-md-50 my-1">
                                                                                                <p
                                                                                                    class="m-0 fw-bolder fs-3">
                                                                                                    <b>Grand
                                                                                                        Total</b>
                                                                                                </p>
                                                                                            ...
                                                                                            <div
                                                                                                class="col-6 d-flex align-items-end justify-content-end my-1">
                                                                                                <div class="text-end">
                                                                                                    <button
                                                                                                        type="submit"
                                                                                                        id="btnSubmit"
