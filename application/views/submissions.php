                                                                                ...
                                                                                <div class="card-header align-items-center py-1 gap-2 gap-md-5">
                                                                                    ...
                                                                                    <div class="card-title">
                                                                                        ...
                                                                                        <div class="d-flex align-items-center position-relative my-1">
                                                                                            ...
                                                                                            <!--end::Svg Icon-->
                                                                                            <input type="text" data-kt-customer-table-filter="search" id="pendingSubmissionTableSearch" onkeyup="searchFunctionPendingSubmission()" class="form-control form-control-solid w-250px ps-15" placeholder="Search Suppliers" />
                                                                                        </div>
                                                                                        <!--end::Search-->
                                                                                    </div>
                                                                                    <!--begin::Card title-->
                                                                                    ...
                                                                                    <div class="card-toolbar w-100">
                                                                                        ...
                                                                                        <div class="d-flex flex-stack flex-wrap gap-4 w-100 align-items-end justify-content-between">
                                                                                            ...
                                                                                            <div class="col-md-2 ">
                                                                                                ...
                                                                                                <input class="form-control d-flex align-items-center" value="" id="kt_tagify_suppliersInvoiced" placeholder="Select Supplier" />
                                                                        ...
                                                                        <div class="col-xl-12">
                                                                            ...
                                                                            <div class="card card-flush h-xl-100">
                                                                                ...
                                                                                <div class="card-body pt-0">
                                                                                    ...
                                                                                    <div class="row w-100">
                                                                                        <table class="table table-fixed table-row-bordered">
                                                                                            <thead>
                                                                                                <tr>
                                                                                                    <th class="col-3 text-start px-4 text-gray-400 fw-bold fs-7 text-uppercase">
                                                                                                        Member Name</th>
                                                                                                    <th class="col-3 text-start px-2 text-gray-400 fw-bold fs-7 text-uppercase">
                                                                                                        Amount</th>
                                                                                                    <th class="col-2 text-start px-2 text-gray-400 fw-bold fs-7 text-uppercase">
                                                                                                        Action</th>
                                                                                                    <th class="col-2 text-start px-2 text-gray-400 fw-bold fs-7 text-uppercase">
                                                                                                        Last Submission
                                                                                                        Total</th>
                                                                                                    <th class="col-2 text-start px-0 text-gray-400 fw-bold fs-7 text-uppercase">
                                                                                                        Last Submission
                                                                                                    </th>
                                                                                                </tr>
                                                                                            </thead>
                                                                                    ...
                                                                                    <div class="d-flex justify-content-between my-3 align-items-center" style="margin-top:40px;">
                                                                                        <div class="rounded-2 bg-light-primary p-3 w-550px d-flex justify-content-between">
                                                                                        ...
                                                                                        <div class="d-flex">
                                                                                            <div class="text-end"><a class="btn btn-sm btn-success me-2 rounded-4" href="javascript:;">Submit</a>
                                                                                            </div>
                                                                                            <div class="text-end"><a class="btn btn-sm btn-danger me-2 rounded-4" href="javascript:;">Cancel</a>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                    <!--end::Card body-->
