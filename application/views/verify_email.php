...
<div id="#kt_app_body_content" style="background-color:#ffffff; font-family:Arial,Helvetica,sans-serif; line-height: 1.5; min-height: 100%; font-weight: normal; font-size: 15px; color: #2F3044; margin:0; padding:0; width:100%;">
    <div style="background-color:#e3e3e3; padding: 45px 0 34px 0; border-radius: 24px; margin:40px auto; max-width: 600px;">
                    ...
                    <td align="center" valign="center" style="text-align:center; padding-bottom: 10px">
                        ...
                        <div style="text-align:center; margin:0 15px 34px 15px">
                            ...
                            <div style="margin-bottom: 10px">
                                <a href="http://localhost/buyyn" rel="noopener" target="_blank">
                                    <img alt="Logo" src="http://localhost/buyyn/assets/media/logos/logo.png" style="height: 35px" />
                                </a>
                            </div>
                            <!--end:Logo-->
                            <!--begin:Media-->
                            <div style="margin-bottom: 15px">
                                <img alt="Logo" src="https://preview.keenthemes.com/metronic8/demo1/assets/media/email/icon-positive-vote-1.svg" />
                            </div>
                            <!--end:Media-->
                            <!--begin:Text-->
                        ...
                        <div style="background: #F9F9F9; border-radius: 12px; padding:35px 30px">
                            ...
                            <div style="display:flex">
                                ...
                                <div style="display: flex; justify-content: center; align-items: center; width:40px; height:40px; margin-right:13px">
                                    <img alt="Logo" src="/metronic8/demo1/assets/media/email/icon-polygon.svg" />
                ...
                <tr>
                    <td align="center" valign="center" style="text-align:center; padding-bottom: 20px;">
                        <a href="#" style="margin-right:10px">
                            <img alt="Logo" src="/metronic8/demo1/assets/media/email/icon-linkedin.svg" />
                        </a>
                        <a href="#" style="margin-right:10px">
                            <img alt="Logo" src="/metronic8/demo1/assets/media/email/icon-dribbble.svg" />
                        </a>
                        <a href="#" style="margin-right:10px">
                            <img alt="Logo" src="/metronic8/demo1/assets/media/email/icon-facebook.svg" />
                        </a>
                        <a href="#">
                            <img alt="Logo" src="/metronic8/demo1/assets/media/email/icon-twitter.svg" />
                        </a>
                    </td>
                </tr>
                <tr>
