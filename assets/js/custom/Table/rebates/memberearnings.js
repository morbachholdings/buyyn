"use strict";
var KTAppEcommerceEarnings = (function () {
  var t,
    e,
    o = () => {
      t.querySelectorAll(
  ...
  return {
    init: function () {
      (t = document.querySelector("#kt_ecommerce_earning_table_1")) &&
        ...
        document
          .querySelector('[data-kt-ecommerce-earning-filter="search"]')
          .addEventListener("keyup", function (t) {
            e.search(t.target.value).draw();
          }),
        (() => {
          const t = document.querySelector(
            '[data-kt-ecommerce-earning-filter="status"]'
          );
          $(t).on("change", (t) => {
