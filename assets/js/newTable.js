...
var KTAppEcommerceSalesListing = (function () {
	...
	var initFlatpickr = () => {
		const element = document.querySelector("#kt_ecommerce_sales_flatpickr3");
	...
	var handleSearchDatatable = () => {
		const filterSearch = document.querySelector(
			'[data-kt-ecommerce-order-filter="search_new3"]'
		);
	...
	var handleStatusFilter = () => {
		const filterStatus = document.querySelector(
			'[data-kt-ecommerce-order-filter="status_new3"]'
		);
	...
	var handleClearFlatpickr = () => {
		const clearButton = document.querySelector(
			"#kt_ecommerce_sales_flatpickr_clear3"
		);
	...
	var handleDeleteRows = () => {
		...
		const deleteButtons = table.querySelectorAll(
			'[data-kt-ecommerce-order-filter="delete_row_new"]'
		);
	...
	return {
		init: function () {
			table = document.querySelector("#kt_ecommerce_sales_table3");
