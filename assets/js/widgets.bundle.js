...
"undefined" != typeof module && (module.exports = KTTablesWidget4),
  ...
  var KTTablesWidget4_1 = (function () {
    var e, t, a;
    const l = () => {
        const e = document.querySelector(
          '[data-kt-table-widget-4_1="filter_status"]'
        );
        $(e).on("select2:select", function (e) {
          const a = $(this).val();
          "Show All" === a ? t.search("").draw() : t.search(a).draw();
      ...
      o = () => {
        const e = document.querySelectorAll(
            '[data-kt-table-widget-4_1="expand_row_1"]'
          ),
          t = [3, 1, 3, 1, 2, 1];
        e.forEach((e, a) => {
          e.addEventListener("click", (l) => {
            ...
            if (o.classList.contains("isOpen")) {
              for (
                ...
                o.nextSibling &&
                "subtable_template" ===
                  o.nextSibling.getAttribute("data-kt-table-widget-4_1");
      ...
      i = (t, l) => {
        t.forEach((r, o) => {
          const i = a.cloneNode(!0),
            s = i.querySelector('[data-kt-table-widget-4_1="template_image"]'),
            n = i.querySelector('[data-kt-table-widget-4_1="template_name"]'),
            d = i.querySelector(
              '[data-kt-table-widget-4_1="template_description"]'
            ),
            m = i.querySelector('[data-kt-table-widget-4_1="template_cost"]'),
            c = i.querySelector('[data-kt-table-widget-4_1="template_qty"]'),
            g = i.querySelector('[data-kt-table-widget-4_1="template_total"]'),
            f = i.querySelector('[data-kt-table-widget-4_1="template_stock"]'),
            u = s.getAttribute("data-kt-src-path");
          s.setAttribute("src", u + r.image + ".gif"),
            (n.innerText = r.name),
            (d.innerText = r.description),
      ...
      s = () => {
        document
          .querySelectorAll('[data-kt-table-widget-4_1="subtable_template"]')
          .forEach((e) => {
            e.parentNode.removeChild(e);
          });
        e.querySelectorAll("tbody tr").forEach((e) => {
          e.classList.remove("isOpen"),
            e.querySelector('[data-kt-table-widget-4_1="expand_row_1"]') &&
              e
                .querySelector('[data-kt-table-widget-4_1="expand_row_1"]')
                .classList.remove("active");
        });
      };
    return {
      init: function () {
        (e = document.querySelector("#kt_table_widget_4_table_1")) &&
          ((() => {
            const l = document.querySelector(
              '[data-kt-table-widget-4_1="subtable_template"]'
            );
            (a = l.cloneNode(!0)).classList.remove("d-none"),
              l.parentNode.removeChild(l),
              (t = $(e).DataTable({
          ...
          document
            .querySelector('[data-kt-table-widget-4_1="search"]')
            .addEventListener("keyup", function (e) {
              t.search(e.target.value).draw();
            }),
          l(),
  ...
  "undefined" != typeof module && (module.exports = KTTablesWidget4_1),
    KTUtil.onDOMContentLoaded(function () {
      KTTablesWidget4_1.init();
    });
