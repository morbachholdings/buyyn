...
<head>
    ...
    <!--begin::Fonts-->
    <link rel="stylesheet" href="assets/css?family=Poppins:300,400,500,600,700">
    <!--end::Fonts-->
            ...
            >
              ...
              <div class="app-navbar gap-2">
                ...
                <div class="app-navbar-item">
                  <!--begin::Drawer toggle-->
                  <div
                    class="btn btn-icon btn-color-white btn-custom bg-hover-white bg-hover-opacity-10 p-0"
                ...
                <!--end::Activities-->
                <!--begin::Chat-->
                <div class="app-navbar-item m-0">
                  <!--begin::Notifications-->
                  <div class="d-flex align-items-center">
                    <!--begin::Menu- wrapper-->
                   
                    <div
                      class="btn btn-icon btn-color-white btn-custom bg-hover-white bg-hover-opacity-10 w-30px h-30px w-md-40px h-md-40px p-0"
                ...
                <div class="toolbar py-5 py-lg-15" id="kt_toolbar">
                    ...
                    <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
                        ...
                        <div class="page-title d-flex flex-column me-3">
                            <!--begin::Title-->
                            <h1 class="d-flex text-dark fw-bolder my-1">Rebates</h1>
                            <!--end::Title-->
                        </div>
                    </div>
                    <!--end::Container-->
                                      ...
                                      <ul class="nav nav-pills nav-pills-custom row position-relative mx-0 mb-9">
                                          ...
                                          <li class="nav-item col-3 mx-0 p-0">
                                              ...
                                              <a class="nav-link active d-flex justify-content-center w-100 border-0 h-100 py-3" data-bs-toggle="pill" href="#kt_list_widget_10_tab_1">
                                                  <!--begin::Subtitle-->
                                                  <span class="nav-text text-gray-800 fw-bolder fs-6 my-2">SHQ Earnings</span>
                                                  <!--end::Subtitle-->
                                                  <!--begin::Bullet-->
                                          ...
                                          <li class="nav-item col-3 mx-0 px-0">
                                              ...
                                              <a class="nav-link d-flex justify-content-center w-100 border-0 h-100 py-3" data-bs-toggle="pill" href="#kt_list_widget_10_tab_2">
                                                  <!--begin::Subtitle-->
                                                  <span class="nav-text text-gray-800 fw-bolder fs-6 my-2">Member Earnings</span>
                                                  <!--end::Subtitle-->
                                                  <!--begin::Bullet-->
                                                  <span class="bullet-custom position-absolute z-index-2 bottom-0 w-100 h-4px bg-primary rounded"></span>
                                                  <!--end::Bullet-->
...
<div class="card card-flush">
										...
										<tbody class="fw-semibold text-gray-600">
											...
											<tr>
												...
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">12970</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
													<div class="d-flex align-items-center">
														...
														<div class="ms-5">
															<!--begin::Title-->
															<a href="../../demo19/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">Melody Macy</a>
															<!--end::Title-->
														</div>
													</div>
												</td>
												...
												<td class="text-end">
													...
													<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
														...
														<!--begin::Menu item-->
														<div class="menu-item px-3">
															<a href="../../demo19/dist/apps/ecommerce/sales/edit-order.html" class="menu-link px-3">Edit</a>
														</div>
														<!--end::Menu item-->
														<!--begin::Menu item-->
														<div class="menu-item px-3">
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">12971</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
													<div class="d-flex align-items-center">
														...
														<div class="ms-5">
															<!--begin::Title-->
															<a href="../../demo19/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">Ana Crown</a>
															<!--end::Title-->
														</div>
													</div>
												</td>
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">12972</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
													<div class="d-flex align-items-center">
														...
														<div class="ms-5">
															<!--begin::Title-->
															<a href="../../demo19/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">Lucy Kunic</a>
															<!--end::Title-->
														</div>
													</div>
												</td>
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">12973</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">12974</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
													<div class="d-flex align-items-center">
														...
														<div class="ms-5">
															<!--begin::Title-->
															<a href="../../demo19/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">Neil Owen</a>
															<!--end::Title-->
														</div>
													</div>
												</td>
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">12975</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">12976</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
													<div class="d-flex align-items-center">
														...
														<div class="ms-5">
															<!--begin::Title-->
															<a href="../../demo19/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">Ethan Wilder</a>
															<!--end::Title-->
														</div>
													</div>
												</td>
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">12977</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">12978</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">12979</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">12980</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
													<div class="d-flex align-items-center">
														...
														<div class="ms-5">
															<!--begin::Title-->
															<a href="../../demo19/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">Brian Cox</a>
															<!--end::Title-->
														</div>
													</div>
												</td>
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">12981</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
													<div class="d-flex align-items-center">
														...
														<div class="ms-5">
															<!--begin::Title-->
															<a href="../../demo19/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">Olivia Wild</a>
															<!--end::Title-->
														</div>
													</div>
												</td>
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">12982</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">12983</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
													<div class="d-flex align-items-center">
														...
														<div class="ms-5">
															<!--begin::Title-->
															<a href="../../demo19/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">John Miller</a>
															<!--end::Title-->
														</div>
													</div>
												</td>
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">12984</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
													<div class="d-flex align-items-center">
														...
														<div class="ms-5">
															<!--begin::Title-->
															<a href="../../demo19/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">Emma Bold</a>
															<!--end::Title-->
														</div>
													</div>
												</td>
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">12985</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
													<div class="d-flex align-items-center">
														...
														<div class="ms-5">
															<!--begin::Title-->
															<a href="../../demo19/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">Mikaela Collins</a>
															<!--end::Title-->
														</div>
													</div>
												</td>
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">12986</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">12987</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
													<div class="d-flex align-items-center">
														...
														<div class="ms-5">
															<!--begin::Title-->
															<a href="../../demo19/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">Emma Smith</a>
															<!--end::Title-->
														</div>
													</div>
												</td>
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">12988</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">12989</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">12990</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">12991</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">12992</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">12993</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">12994</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">12995</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">12996</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
													<div class="d-flex align-items-center">
														...
														<div class="ms-5">
															<!--begin::Title-->
															<a href="../../demo19/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">Robert Doe</a>
															<!--end::Title-->
														</div>
													</div>
												</td>
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">12997</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
													<div class="d-flex align-items-center">
														...
														<div class="ms-5">
															<!--begin::Title-->
															<a href="../../demo19/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">Francis Mitcham</a>
															<!--end::Title-->
														</div>
													</div>
												</td>
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">12998</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">12999</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13000</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13001</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
													<div class="d-flex align-items-center">
														...
														<div class="ms-5">
															<!--begin::Title-->
															<a href="../../demo19/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">Max Smith</a>
															<!--end::Title-->
														</div>
													</div>
												</td>
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13002</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
													<div class="d-flex align-items-center">
														...
														<div class="ms-5">
															<!--begin::Title-->
															<a href="../../demo19/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">Sean Bean</a>
															<!--end::Title-->
														</div>
													</div>
												</td>
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13003</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
												...
												<!--begin::Total=-->
												<td class="text-end pe-0">
													<span class="fw-bold">$321.00</span>
												</td>
												<!--end::Total=-->
												<!--begin::Date Added=-->
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13004</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13005</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13006</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
													<div class="d-flex align-items-center">
														...
														<div class="ms-5">
															<!--begin::Title-->
															<a href="../../demo19/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">Dan Wilson</a>
															<!--end::Title-->
														</div>
													</div>
												</td>
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13007</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13008</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
												...
												<!--begin::Total=-->
												<td class="text-end pe-0">
													<span class="fw-bold">$312.00</span>
												</td>
												<!--end::Total=-->
												<!--begin::Date Added=-->
												<td class="text-end" data-order="2022-08-02">
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13009</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13010</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13011</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13012</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13013</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13014</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13015</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13016</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
												...
												<!--begin::Total=-->
												<td class="text-end pe-0">
													<span class="fw-bold">$227.00</span>
												</td>
												<!--end::Total=-->
												<!--begin::Date Added=-->
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13017</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13018</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
											...
											<tr>
												...
												<!--begin::Order ID=-->
												<td data-kt-ecommerce-order-filter="order_id">
													<a href="../../demo19/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">13019</a>
												</td>
												<!--end::Order ID=-->
												<!--begin::Customer=-->
												<td>
                ...
                <button class="btn btn-primary ml-4 d-flex justify-content-end">Apply</button>
                <!--end::Indicator label-->
                                                </div>
                                            </div>
                                            </div>
                    ...
                    <div class="card-toolbar w-100">
                      ...
                      <div class="d-flex flex-stack flex-wrap gap-4 w-100 align-items-end justify-content-start">
                        ...
                        <div class=" align-items-center fw-bold">
                          ...
                          <input class="form-control form-control-solid" placeholder="Pick date range" id="kt_daterangepicker_5"/>
                          </div>
