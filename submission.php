        ...
        <div class="page d-flex flex-row flex-column-fluid">
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                    ...
                    <div class="app-container container-xxl d-flex align-items-stretch justify-content-between">
                                ...
                                <div data-kt-search-element="content"
                                    ...
                                    <form data-kt-search-element="advanced-options-form" class="pt-1 d-none">
                                        ...
                                        <div class="d-flex justify-content-end">
                                            ...
                                            <a href="../../demo22/dist/pages/search/horizontal.php"
                        ...
                        <div class="app-navbar gap-2">
                            ...
                            <div class="app-navbar-item">
                                <!--begin::Drawer toggle-->
                                <div class="btn btn-icon btn-color-white btn-custom bg-hover-white bg-hover-opacity-10 p-0"
                            ...
                            <div class="app-navbar-item m-0">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="btn btn-icon btn-color-white btn-custom bg-hover-white bg-hover-opacity-10 w-30px h-30px w-md-40px h-md-40px p-0"
                                        ...
                                        <!--end::Svg Icon-->
                                        <span
                                            class="bullet bullet-dot bg-white h-6px w-6px translate-middle animation-blink indi"></span>
                                    </div>
                                    <!--begin::Menu-->
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane fade" id="kt_topbar_notifications_1" role="tabpanel">
                                                ...
                                                <div class="py-3 text-center border-top">
                                                    <a href="../../demo2/dist/pages/user-profile/activity.php"
                            ...
                            <div class="app-navbar-item" id="kt_header_user_menu_toggle">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                                    ...
                                    <div class="menu-item px-5">
                                        <a href="../../demo22/dist/account/overview.php" class="menu-link px-5">My
                                            Profile</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu separator-->
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-5">
                                        <a href="../../demo22/dist/authentication/layouts/corporate/sign-in.php"
                ...
                <div class="app-header-secondary app-header-mobile-drawer" data-kt-drawer="true"
                    ...
                    data-kt-swapper-mode="append" data-kt-swapper-parent="{default: '#kt_body', lg: '#kt_app_header'}">
                    ...
                    <div class="app-container container-xxl app-container-fit-mobile d-flex align-items-stretch">
                        ...
                        <div class="header-menu d-flex align-items-stretch w-100">
                            <!--begin::Menu-->
                            <div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-state-primary menu-title-gray-700 menu-arrow-gray-400 menu-bullet-gray-400 fw-semibold my-5 my-lg-0 align-items-stretch"
                ...
                <div id="kt_activities" class="bg-body" data-kt-drawer="true" data-kt-drawer-name="activities"
                    ...
                    <div class="card shadow-none border-0 rounded-0">
                                        ...
                                        <div class="timeline-content mb-10 mt-n1">
                                            ...
                                            <div class="overflow-auto pb-5">
                                                ...
                                                <div
                                                    ...
                                                    <!--begin::Title-->
                                                    <a href="../../demo22/dist/apps/projects/project.php"
                                        ...
                                        <div class="timeline-content mb-10 mt-n1">
                                            ...
                                            <div class="overflow-auto pb-5">
                                                <div
                                                    ...
                                                    <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                                        <!--begin::Icon-->
                                                        <img alt="../../demo22/dist/apps/projects/project.php"
                        ...
                        <div class="card-footer py-5 text-center" id="kt_activities_footer">
                            <a href="../../demo22/dist/pages/user-profile/activity.php"
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <ul class="nav row mb-10">
                                            <li class="nav-item col-12 col-lg mb-5 mb-lg-0">
                                                <a class="nav-link btn btn-flex btn-color-muted btn-outline btn-outline-default btn-active-danger d-flex flex-grow-1 flex-column flex-center py-5 h-1250px h-lg-100px active"
                                            ...
                                            <li class="nav-item col-12 col-lg mb-5 mb-lg-0">
                                                <a class="nav-link btn btn-flex btn-color-muted btn-outline btn-outline-default btn-active-danger d-flex flex-grow-1 flex-column flex-center py-5 h-1250px h-lg-100px"
                                                ...
                                                <div class="card card-flush">
                                                    ...
                                                    <div class="card-body pt-0 px-0">
                                                        ...
                                                        <ul
                                                            ...
                                                            <li class="nav-item col-6 mx-0 px-0">
                                                                <!--begin::Link-->
                                                                <a class="nav-link d-flex justify-content-center w-100 border-0 h-100 py-3"
                                                                    data-bs-toggle="pill"
                                                                            ...
                                                                            <div class="card card-flush h-xl-100">
                                                                                ...
                                                                                <div class="card-header border-0 pt-6">
                                                                                    ...
                                                                                    <div class="card-toolbar">
                                                                                        ...
                                                                                        <!--end::Toolbar-->
                                                                                        <!--begin::Group actions-->
                                                                                        <div class="d-flex justify-content-end align-items-center deleteDiv d-block d-none"
                                                                                            
                                                                                            kt-table-widget-4-table-toolbar="selected">
                                                                                            <div class="fw-bold me-5">
                                                                                                <span class="me-2"
                                                                                                    kt-table-widget-4-table-select="selected_count" id="checkCount"></span>Selected
                                                                                            </div>
                                                                                            <button type="button"
