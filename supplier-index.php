              ...
              <div class="d-flex flex-column flex-column-fluid">
                ...
                <div id="kt_app_content" class="app-content flex-column-fluid">
                  ...
                  <div class="row g-5 g-xl-10 mb-xl-10">
                    <!--begin::Col-->
                    <div
                      class="col-md-12 col-lg-6 col-xl-6 col-xxl-6 mb-md-5 mb-xl-10"
                    >
                      <!--begin::Card widget 5-->
                  ...
                  <div class="row gy-5 g-xl-10">
                    ...
                    <div class="col mb-xl-10">
                      <div class="card h-100">
                        <div class="flex-md-row d-flex mobileAlign align-items-end justify-content-end mt-3 mb-3 p-2">
                          ...
                          <div class="card-toolbar">
                            ...
                            <div class="d-flex flex-stack flex-wrap gap-4">
                              ...
                              <div class="position-relative my-1">
                                ...
                                <input
                                  type="text"
                                  id="processLogTableSearch"
                                  onkeyup="searchFunctionProcessLog()"
