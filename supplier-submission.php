                    ...
                    <div class="app-container container-xxl app-container-fit-mobile d-flex align-items-stretch">
                        ...
                        <div class="header-menu d-flex align-items-stretch w-100">
                            ...
                            <div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-state-primary menu-title-gray-700 menu-arrow-gray-400 menu-bullet-gray-400 fw-semibold my-5 my-lg-0 align-items-stretch"
                                ...
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link py-3" href="supplier-index.php">
                                ...
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link py-3" href="supplier-submission.php">
                                        <span class="menu-title">
                                ...
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link py-3" href="supplier-reports.php">
                                        <span class="menu-title">
                                ...
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link py-3" href="supplier-processLog.php">
                                        <span class="menu-title">
                                                                                ...
                                                                                <div class="card-body p-1">
                                                                                    ...
                                                                                    <div class="row gy-5 g-xl-10">
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <!--begin::Table Widget 4-->
                                                                                            <div
                                                                                                class="card card-flush h-xl-100 p-0">
